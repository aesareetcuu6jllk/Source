...
_buttons = {
    ...
    "apauto": {
        "text": f"⎆ من هنا يمكنك تفعيل السماح التلقائي او تعطيله، عند تفعيل هذا المتغير عندما يراسلك شخص وأنت قد فعلت نظام حماية الخاص وقتها سيمكنك السماح للشخص بالدردشة معك فقط عبر ان تراسله في الخاص بدلا من إرسال امر `{HNDLR}سماح`",
        "buttons": [
